...
// at runtime that are necessary for running the Kubelet. This is a temporary（临时） solution for grouping
// these objects while we figure out a more comprehensive（全面） dependency injection story for the Kubelet.
